...
const labelStyles =
	'absolute left-4 pointer-events-none top-0 translate-y-2 scale-75 z-10 transform text-sm text-muted-foreground duration-300 peer-focus:translate-y-2 peer-focus:top-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:scale-75 peer-focus:text-primary origin-top-left font-normal'

const Input = React.forwardRef<HTMLInputElement, InputProps>(
	({ className, type, label, isForm = false, placeholder, ...props }, ref) => {
		return (
